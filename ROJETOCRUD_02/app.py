...
class Application: 
    ...
    def __init__(self,master=None):
        ...
        self.lblidusuario = Label(self.container2,text="IdUsiario:",font=self.fonte,width=10)
    ...
    #CONSTRUCAO DOS BOTOES (alterar,excluir,limpar)
    ...
    def inserirUsuario(self):
        ...
        self.cursor.execute("INSERT INTO usuario(nome,telefoe,email,usuario,senha)VALUES(%s,%s,%s,%s,%s)",
    ...
    def excluirUsuario(self):
        ...
        self.cursor.execute("DELETE FROM aluno WHERE idusuario=%s",(idusuario))
        self.conn.commit()
    ...
    def buscarUsuario(self):
        idusuario = self.txtidusuario.get()
        self.cursor.execute("SELECT * FROM aluno WHERE idusuario=%s",(idusuario,))
        usuario = self.cursorferchone()
